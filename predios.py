...
lista_credenciados = ("2", "5", "7")                    #lista provisória de credenciados no predio
...
while True:
    ...
    if (id_requisicao in lista_credenciados) and (visitante == "cadastrado"):       #Tratamento das requisições
        socket.send_string("Cliente %s permitido e credenciado" % id_requisicao)    #caso de cliente na lista do predio e credenciado
    else:
        if visitante == "visitante":                                                #caso de cliente visitando o predio
